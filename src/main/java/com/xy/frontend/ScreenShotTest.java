...
{
    private FileOcr2 superWindow;

    public ScreenShotTest(FileOcr2 superWimdow)
    {
...
class ScreenShotWindow extends JWindow
{
    ...
    private FileOcr2 superWin;

    public ScreenShotWindow(FileOcr2 superWindow) throws AWTException
    {
